...
#define _kb_  8.617333262e-5        // Boltzmann constant in eV K^-1, multiply a quantity which is in K with _kb_ to get the quantity in eV
#define _hbar_ 6.582119569e-16      // Reduced Planck constant in eV s
#define _sol_ 2.99792458e8          // Speed of Light in m s^-1, I take the same definition as class in background.h
#define _m_to_Mpc_ 3.240779289e-23  // Conversion of 1m to Mpc, multiply 1m with this quantity to get quantity in Mpc
#define _eV_to_kg_ 1.782661921627e-36  // conversion of 1eV to kg, multiply 1eV with this quantity to get quantity in kg
#define _eV4_to_Mpc2_ 1.374334e+03      // conversion of eV^4 to Mpc^-2, multiply 1eV^4 with this quantity to get quantity in Mpc^-2
