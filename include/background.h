...
struct background
{
  ...
  double mu_nu_ini;
  double mass_maj;
  double gamma_eff_maj;
  double gnu;
  double gphi;
  double delta_neff_majoron;
  double decay_ratio;
  double full_thermo_lower_limit;
  double print_steps_maj;
  double wcbf;
  double fine_steps_maj;
  ...
  /* majoron-neutrino -- start */
  int index_bg_Temp_maj;
  int index_bg_Temp_nu_int;
  int index_bg_mu_maj;
  int index_bg_mu_nu_int;
  int index_bg_rho_maj;
  int index_bg_p_maj;
  int index_bg_rho_nu_int;
  /* majoron-neutrino -- end */
  ...
  /* majoron-neutrino -- start */
  int index_bi_Temp_maj;
  int index_bi_Temp_nu_int;
  int index_bi_mu_maj;
  int index_bi_mu_nu_int;
  /* majoron-neutrino -- end */
